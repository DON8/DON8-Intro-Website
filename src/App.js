  ...
  return (
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="column2">
          <p class="intro-welcome">
            Welcome to DON8<br></br>
            <p class="descriptor">Food, drinks, and donation</p>
          </p>
        </div>
      </div>
      ...
      <div class="description">
        <p>
          DON8 is the most feel-good app out there, allowing <i>you</i> to
          donate food while enjoying it too. Order from your favourite local
          restaurants and take part in campaigns to help out those who can't.
        </p>
        <br></br>
        <br></br>
      </div>
      ...
      <div class="download">
        <a href="https://github.com/DON8/DON8-App">
          <div>
